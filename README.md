...
### Functions
all functions should have a correctly punctuated description and `@param` description for each in all lowercase. A `@return` description should be provided in same way in applicable.
...
### Copyright
All classes should include the Apollo Copyright from below. It will be ideal to set a Copyright profile in intilJ to this so it will be automatically imputed to each class. However this isn't mandatory and can easily be inputed once merged with main branch so don't be to worried about it.
