...
/**
 * Called when module is disabled and after initiation if disabled by default.
 *
 * @author Icovid | Icovid#3888
 * @since b0.2
 */
public class DisableEvent extends ModuleEvent {

    /**
     * @param module module event is being called by, really only useful
     *               when different target is set
     */
    public DisableEvent(ModContainer module) {
        super(module);
    }
}
