...
/**
 * Called when module is enabled and after initiation if enabled by default.
 *
 * @author Icovid | Icovid#3888
 * @since b0.2
 */
public class EnableEvent extends ModuleEvent {

    /**
     * @param module module event is being called by, really only useful
     *               when different target is set
     */
    public EnableEvent(ModContainer module) {
        super(module);
    }
}
