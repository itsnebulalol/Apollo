...
public class Apollo {
  ...
  public static final File apolloDirectory =
      new File(System.getProperty("user.dir") + "/" + NAME.toLowerCase());
  public static final File settingsFile =
      new File(System.getProperty("user.dir") + "/" + NAME.toLowerCase() + "/settings.txt");
  ...
  public void postInitialisation() {
    log(
        "Apollo Initiation Finished with "
            + MODULE_MANAGER.preInitialisation()
            + " Modules and 0 Settings! ");
  ...
  public static void log(String... message) {
    for (String out : message)
      System.out.println(
          "[" + new SimpleDateFormat("HH:mm:ss").format(new Date()) + "] [Apollo] " + out);
  }
  ...
  public static void error(String... message) {
    for (String out : message)
      System.err.println(
          "[" + new SimpleDateFormat("HH:mm:ss").format(new Date()) + "] [Apollo-Error] " + out);
  }
